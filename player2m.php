...
<body>
	...
	<div id="tahta" class="divs" style="width:460px;float:none;">
	...
	</div><div style="width:500px;float:none;">
	<div class="divs plyr">
		<h3><a id="name1">Player 1</a><br><a style="color:red">( X )</a></h3>
		<h2 id="score1">0</h2>
		.<a id="turn1">Your Turn : 5</a>
	</div><div style="height:400px;width:3px;background-color:white;position:relative;top:500px;opacity:0.5;"></div>
	<div class="divs plyr">
	...
	</center><br><center><div style="width:600px;top:150px;position:relative;float:none;"><a id="save" onclick="save()" style="">Save Challange</a> | <a id="leaderboard" onclick="leaderboard()" style="">Leaderboard</a><br>
	...
	<script type="text/javascript">
		...
		function resize(){
			...
			var tahtax = document.getElementById('tahta').style.left;
			var ylineleft = tahtax+354;
			var y2lineleft = tahtax+509;
			var xlineleft = tahtax+225;
			document.getElementById('xline1').style.left = (xlineleft)+"px";
			document.getElementById('xline2').style.left = (xlineleft)+"px";
			document.getElementById('yline1').style.left = (ylineleft)+"px";
			document.getElementById('yline2').style.left = (y2lineleft)+"px";
		}
		...
		function floop(){
			...
			if(wins==0){
				if(turn==1){
					...
					document.getElementById('turn1').innerHTML = "His Turn : " + sayac;
					hak = 1;
				}else{
				...
				document.getElementById('turn2').innerHTML = "";
				document.getElementById('turn1').innerHTML = "HE WON : " + sayac;
			}else if(wins==2){
				document.getElementById('turn1').innerHTML = "";
