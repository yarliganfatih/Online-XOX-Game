...
<body>
	...
	</center><center><div style="width:600px;top:150px;position:relative;float:none;"><a id="stopper" onclick="stopm()" style="">Stop</a> | <a id="leaderboard" onclick="leaderboard()" style="">Click for Online</a><br>
